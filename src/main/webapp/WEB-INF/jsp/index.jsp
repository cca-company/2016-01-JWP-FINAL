...
<body>
	<div class="issues issues--wrap mdl-layout mdl-js-layout is-upgraded">
		...
		<div class="issues__posts mdl-grid">
			<div class="issues-card-wide mdl-card mdl-shadow--2dp">
				<div class="mdl-card__title" style="height:80px;">
              		<h2 class="mdl-card__title-text mdl-color-text--grey-800">Issues</h2>
				</div>
				<a href="/newIssue"
						...
						<c:forEach items="${issues}" var="issue">
							<li class="mdl-list__item mdl-list__item--two-line">
								<span class="mdl-list__item-primary-content">
								    <a> 
								         <img class="mdl-list__item-avatar" height="48" width="48" src="${issue.writerPic}" alt="${issue.writerName}">
									</a> 
									...
									<span class="mdl-list__item-sub-title"> 
									    ...
									    <relative-time datetime="${issue.date}" title="${issue.date}">${issue.date}</relative-time> 
									    by <a href="" aria-label="View all issues opened by javajigi" class="tooltipped tooltipped-s muted-link">${issue.writerName}</a>
									</span>
								</span> 
								<span class="mdl-list__item-secondary-content">
									<span class="material-icons mdl-badge mdl-badge--overlap" data-badge="${issue.commentNum}">comment</span>
								</span>
							</li>
						</c:forEach>
