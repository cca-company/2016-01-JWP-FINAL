  ...
  <body>
    ...
    <header class="mdl-layout__header mdl-layout__header--waterfall">
      ...
      <main class="mdl-layout__content">
        ...
        <form action="/updateIssue/${issue.id}" method="post">
            <div class="mdl-card__title mdl-color-text--grey-50" style="height:100px;">
              ...
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" style="width:90%">
                <input class="mdl-textfield__input" value="${issue.subject}" type="text" id="subject" name="subject">
            ...
            <div class="mdl-color-text--primary-contrast mdl-card__supporting-text new-comment">
              <div class="mdl-textfield mdl-js-textfield" style="width:100%">
                <textarea class="mdl-textfield__input" style="color:#888" type="text" rows= "10" id="comment" name="comment" >${issue.comment}</textarea>
